...
<body>
	<a href="process.jsp?email=dltmdghks94@gmail.com&pw=1234">process로 이동</a><br />
...
<script>
	...
	ajax.addEventListener("click",function(e){
		...
		//요청을 생성하고 요청
		//request.open('GET', 'process.jsp?email=ggangpae1');
		
		//ajax에서 post방식으로 파라미터 전송
